...
proc create_root_design { parentCell } {
  ...
  set pwm_o_1 [ create_bd_port -dir O pwm_o_1 ]
...
CONFIG.PWM_FREQ {50} \
  ...
  # Create instance: esc_controller_1, and set properties
  set esc_controller_1 [ create_bd_cell -type ip -vlnv user.org:user:esc_controller:1.0 esc_controller_1 ]
  set_property -dict [ list \
CONFIG.CLK_FREQ {100000000} \
 ] $esc_controller_1
...
CONFIG.NUM_MI {2} \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins esc_controller_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins esc_controller_1/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]

  # Create port connections
  connect_bd_net -net esc_controller_0_pwm_o [get_bd_ports pwm_o] [get_bd_pins esc_controller_0/pwm_o]
  connect_bd_net -net esc_controller_1_pwm_o [get_bd_ports pwm_o_1] [get_bd_pins esc_controller_1/pwm_o]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins esc_controller_0/s00_axi_aclk] [get_bd_pins esc_controller_1/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins esc_controller_0/s00_axi_aresetn] [get_bd_pins esc_controller_1/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins esc_controller_0/reset_i] [get_bd_pins esc_controller_1/reset_i] [get_bd_pins xlconstant_0/dout]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs esc_controller_0/S00_AXI/S00_AXI_reg] SEG_esc_controller_0_S00_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs esc_controller_1/S00_AXI/S00_AXI_reg] SEG_esc_controller_1_S00_AXI_reg
...
preplace port pwm_o -pg 1 -y 150 -defaultsOSRD
preplace port pwm_o_1 -pg 1 -y 290 -defaultsOSRD
...
preplace inst rst_ps7_0_100M -pg 1 -lvl 1 -y 250 -defaultsOSRD
preplace inst esc_controller_0 -pg 1 -lvl 3 -y 150 -defaultsOSRD
preplace inst esc_controller_1 -pg 1 -lvl 3 -y 290 -defaultsOSRD
...
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 1 2 470 350 780
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 2 30 160 430
preplace netloc esc_controller_1_pwm_o 1 3 1 N
...
preplace netloc esc_controller_0_pwm_o 1 3 1 NJ
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 20 150 460 360 770
preplace netloc ps7_0_axi_periph_M00_AXI 1 2 1 N
preplace netloc rst_ps7_0_100M_interconnect_aresetn 1 1 1 450
levelinfo -pg 1 0 230 610 890 1020 -top 0 -bot 600
",
}
